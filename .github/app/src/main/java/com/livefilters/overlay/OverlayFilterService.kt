...
class OverlayFilterService : Service() {
    ...
    private var sharpness = 1.2f
    private var saturation = 1.5f
    ...
    private fun createControls(): View {
        ...
        layout.addView(TextView(this).apply { text = "Резкость"; setTextColor(Color.WHITE) })
        layout.addView(SeekBar(this).apply {
            max = 200; progress = 100
            setOnSeekBarChangeListener(object : SeekBar.OnSeekBarChangeListener {
                override fun onProgressChanged(s: SeekBar, p: Int, f: Boolean) {
                    sharpness = 0.5f + p / 100f
                }
        ...
        layout.addView(TextView(this).apply { text = "Насыщенность"; setTextColor(Color.WHITE) })
        layout.addView(SeekBar(this).apply {
            max = 300; progress = 150
            setOnSeekBarChangeListener(object : SeekBar.OnSeekBarChangeListener {
                override fun onProgressChanged(s: SeekBar, p: Int, f: Boolean) {
                    saturation = p / 100f
                }
